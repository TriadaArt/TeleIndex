...
export default function Owners(){
  ...
  const load = async () => {
    ...
    const { data } = await axios.get(`${API}/admin/users?role=owner&page=${page}&limit=${limit}`, { headers: { Authorization: `Bearer ${token}` } });
    setItems(data.items || []);
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-4">Владельцы</h1>
